...
export default async function ApplicationsPage({params, searchParams}: {params: Promise<{locale: string}>; searchParams: Promise<{status?: string}>}) {
  ...
  return <ApplicationsClient locale={locale} statusFilter={status} copy={{
    ...
    applicationDeadline: t("applications.applicationDeadline"),
    delete: t("applications.delete"),
    deleteTitle: t("applications.deleteTitle"),
    deleteMessage: t("applications.deleteMessage"),
    confirmDelete: t("applications.confirmDelete"),
    deleting: t("applications.deleting"),
    cancel: t("applications.cancel"),
    roleMissing: t("applications.roleMissing"),
