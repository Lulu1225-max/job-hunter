...
class GenerateAnswerRequest(BaseModel): experience_id:UUID|None=None;answer_length:Literal["30s","1min","2min"]="1min";regenerate:bool=False;question_type:Literal["experience","knowledge","motivation","case"]|None=None
